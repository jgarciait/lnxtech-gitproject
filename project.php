...
<a href="home.php" type="button" class="btn btn-xs btn-danger">Logout</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                         Proyectos de Document Control Systems
                        </h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2>Proyectos</h2> <a href="addReport.php?action=add" type="button" class="btn btn-xs btn-primary"><h5>Añada Nuevo Reporte</h5></a>
                 <a href="addProject.php?action=add" type="button" class="btn btn-xs btn-info"><h5>Añada Proyecto</h5></a>
                 <a href="report.php?" type="button" class="btn btn-xs btn-success"><h5>Ir a Reportes</h5></a>  
                 <a href="chartByProject.php" type="button" class="btn btn-xs btn-info"><h5>Gráficas por Proyecto</h5></a>  
                 <div class="table-responsive">
                        ...
                        ?>                 
                              ...
                              <?php
                                echo "<td><form method='POST' action='delProject.php'>";
